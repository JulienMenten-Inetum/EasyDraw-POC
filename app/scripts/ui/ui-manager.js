  ...
  if (buttons.length > 0) {
    ...
    buttons.forEach((button) => {
      ...
      uiDef.buttons.forEach((buttonDef) => {
        const addButtonDef =
          buttonDef.name === button ||
          (addLineButtons && buttonDef.palette === "lines") ||
          (addShapeButtons && buttonDef.palette === "shapes") ||
          (addStampButtons &&
            (buttonDef.palette === "stampCategories" ||
              buttonDef.palette.indexOf("StampsPalette") >= 0));
        if (addButtonDef) {
